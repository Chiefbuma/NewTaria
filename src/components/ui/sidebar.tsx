        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            <SheetHeader className="sr-only">
              ...
              <SheetDescription>Primary navigation for the dashboard.</SheetDescription>
            </SheetHeader>
      ...
      >
        ...
        <div
          className={cn(
            ...
            "h-[calc(100svh-3.5rem)] md:h-[calc(100svh-60px)]",
        ...
        <div
          className={cn(
            ...
            "top-14 h-[calc(100svh-3.5rem)] md:top-[60px] md:h-[calc(100svh-60px)]",
            side === "left"
